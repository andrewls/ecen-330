...
supportFiles/%.o: ../supportFiles/%.cpp
	...
	arm-xilinx-eabi-g++ -Wall -O0 -g3 -I"Y:\Code\school\330\my330\Consolidated_330_SW" -c -fmessage-length=0 -I../../Consolidated_330_SW_bsp/ps7_cortexa9_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
